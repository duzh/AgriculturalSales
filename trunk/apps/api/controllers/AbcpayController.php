...
class PayController extends ControllerBase
{
    ...
    public function getpayurlAction() 
    {
        ...
        $_POST=array(
            ...
            'ReceiveAccName' => '',
            'NotifyType' => '1',
            'ResultNotifyURL' => 'http://www.5fengshou.com/api/abcpay/callback',
            'MerchantRemarks' => 'Hi',
            'IsBreakAccount' => '0',
            'SplitAccTemplate' => '',
        );
    ...
    public function callbackAction(){
        ...
        if ($tResponse->isSuccess()) {
            ...
            try
            {
                ...
                $phql = sprintf($sql, Orders::PAY_STATE, $orders['purid'], $orders['purname'], 0, time() , '支付订单', $orders['id']);
            ...
            if($flag==0){
                echo "<input type='hidden' value='0' name='5fengshou_abcpay_resultcode' >";die;
            }else{
                echo "<input type='hidden' value='1' name='5fengshou_abcpay_resultcode' >";die;
            }
