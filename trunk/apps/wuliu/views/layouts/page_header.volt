        ...
        <div class="w1190 mtauto f-pr clearfix" style="*z-index:6;">
            ...
            *** 此按钮首页不应显示，其他页均应显示
            ...
            <div class="vertical-navgation">
                ...
                <div class="vert-box clearfix" {% if _nav == "index" %}style="display:block;"{% else %}style="display:none;"{% endif %}>
                    <!-- 分类 -->
                {% if haeder_cate %}
    ...
    <div class="fixed-nav">
        <div class="w1190 mtauto clearfix">
            ...
            <div class="hotwords f-fl">
                    ...
                    <a href="http://www.5fengshou.com/sell/index?search_header_type=sell&keyword={{keyword}}">{{val['title']}}
                    </a><em>|</em> 
                    {% endfor %}
            </div>
            <form action="/index/search" >
