...
{{ partial('layouts/page_header') }}
	...
	<div class="wrapper pb30">
		...
		<div class="bread-crumbs w1185 mtauto">
			<a href="/">首页</a> > <a href="/tag/index">{% if sell.is_source %}可追溯产品{% else %} 供应产品{% endif %}</a> > 详情
		</div>
				...
				<div class="magnifier clearfix">
					<dl class="f-fl">
	                    <dt>
							...
							{% if curImg  %}
	                    		<img src="{{ curImg }}" width="300" height="300" />
								{% else %}
                                <img  src="<?php echo  Mdg\Models\Image::imgmaxsrc($cateid) ?>" width="300" height="300" />
                            {% endif %}
	                    	</a>
	                    </dt>
	                    <dd>
	                        ...
	                        <div class="ul_box">
	                            <ul>
								{% for key, img in imgs %}
	                                <li class="active"><a href="javascript:;"><img src="{{ constant('IMG_URL') }}{{ img['path'] }}" /></a></li>
									 {% endfor %}
	                            </ul>
	                        </div>
				...
				<div class="supply-featured-box">
					...
					<div class="supply-featured-list">
						<a href="/sell/info/{{ val['id'] }}">
							<div class="imgs">
							 {% if val['thumb']  %}
								<img src="{{ constant('IMG_URL') }}{{ val['thumb'] }}" height="130" width="130">
								{% else %}
								<img src="http://static.ync365.com/mdg/images/detial_b_img.jpg" height="142" width="142">
								{% endif %}
							</div>
