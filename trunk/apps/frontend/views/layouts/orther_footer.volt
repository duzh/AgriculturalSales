 <div class="footer-helpList">
        ...
        $value) {  ?>
            ...
            $v) { ?>
                <dd>
                     <a href="http://www{{ constant('CUR_DEMAIN') }}/article/index?p=<?php echo $v['id'] ?>
                    ">
                    <?php echo $v["title"]?></a>
                </dd>
              <?php } ?>     
    ...
    <div class="scrollBox">
        <div class="box clearfix">
            ...
            <!-- 查询 -->
            <div class="cx">
                <a href="http://www{{ constant('CUR_DEMAIN') }}/map/map">
                    <div class="imgs"></div>
                    <div class="imgTips">
            ...
            <!-- 下载APP -->
            <div class="load-app">
                <a href="http://www{{ constant('CUR_DEMAIN') }}/index/ad">
                    <div class="imgs"></div>
                    <div class="imgTips">
                        <div class="right-arrow"></div>
                        <span>下载APP</span>
           ...
           <!--  <div class="feed-back">
            ...
            <div class="contact-service">
                <a href="http://www{{ constant('CUR_DEMAIN') }}/article/index?p=15">
                    <div class="imgs"></div>
                    <div class="imgTips">
                        <div class="right-arrow"></div>
                        <span>联系客服</span>
