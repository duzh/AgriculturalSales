    ...
    <div class="header-logo">
        <div class="w1190 mtauto clearfix">
            ...
            <div class="searchBox f-fl">
                ...
                <div class="hotwords">
                    {% for val in  hotsell %}
                    <a href="http://www{{ constant('CUR_DEMAIN') }}/sell/index?search_header_type=sell&keyword={{val['title']}}">{{val['title']}}
                    </a><em>|</em> 
                    {% endfor %}
                </div>
            </div>
        ...
        <div class="w1190 mtauto f-pr clearfix" style="*z-index:6;">
            ...
            *** 此按钮首页不应显示，其他页均应显示
            ...
            <div class="navBtn f-oh">
                <a class="gy-btn" href="http://www{{ constant('CUR_DEMAIN') }}/member/sell/new">发布供应</a>
                <a class="cg-btn" href="javascript:newWindows('newpur', '发布采购', 'http://www{{ constant('CUR_DEMAIN') }}/member/dialog/newpur');">发布采购</a>
            </div>
			 {% endif %}
                    ...
                    <div class="cateBox cateBox{{key + 1 }}">
                        ...
                        <div class="core-box">
                            ...
                            <div class="fb-list{{ row }}">
                                 ...
                                 {% for v in val %}
                                <a href="http://www{{ constant('CUR_DEMAIN') }}/sell/mc{{v['parent_id']}}_a0_c{{v['id']}}_f{{v['abbreviation']}}_p1">{{ v['title']}}</a>
                                {% endfor %}
                            </div>
                           {% endfor %}
                            <?php } ?>
