    ...
    <div class="center_right f-fr">
        <div class="my_banlance">
            ...
            <div class="money clearfix">
                <div class="left f-fl">
                    我的余额
                    <br /> <strong><?php echo isset($userData->value)&&$userData->value>0 ? ($userData->value) : '0.00'; ?></strong>
                    元
                </div>
                ...
                <div class="chaxun clearfix">
                    ...
                    <span> <font>交易类型：</font>
                        <select name="orderStatus" id="orderStatus">
                            <option value="3" <?php if(isset($_GET['orderStatus']) &&$_GET['orderStatus']== '3'){ echo 'selected';}?>>所有状态</option>
                    ...
                    <span>
                        <font>流水号：</font>
                        <input class='txt' name="serialNum" id="serialNum" type="text" value="<?php if(isset($_GET['serialNum'])){ echo trim($_GET['serialNum']); }?>"></span>
                    <br />
                    <br />
