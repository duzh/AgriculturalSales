...
<div class="dialog" style="width:300px;height:200px" id="dialog">
    <p style="line-height:30px; margin-top:30px; padding-left:0; text-align:center;">申请成功</p>
    <div class="btn mt30">
        <input class="submit_btn" id='butto' type="button" value="发布采购" onclick="closeall()" >
        <input class="submit_btn" type="button" value="继续看货" onclick="closelog()">
    </div>
...
function closeall(){
    ...
    location.href="/member/dialog/newpur/";
}
</script>