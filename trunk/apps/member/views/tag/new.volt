    ...
    <div class="w1190 mtauto f-oh">
        ...
        <div class="center-right f-fr">
            ...
            <div class="apply-tag f-oh">
                ...
                <form action="/member/tag/create" method="post" id="applyForm">
                    <div class="m-title">基本信息</div>
                    <div class="message clearfix">
                        <font>
                            <i>*</i>品名：
                        </font>
                        <div class="wz">{{ data.title}}</div>
                    </div>
                    <div class="message clearfix">
                        <font>
                            <i>*</i>产地：
                        ...
                        <div class="selectBox selectBox1 f-pr">
                            ...
                            <select name="village" data-target="#dz-yz1" class="select1">
                                <option value="">办事处</option>
                            </select>
                            <div class="f-db f-oh mt10">
                                <input name="address" data-target="#dz-yz2" class="input1 f-fl" type="text" placeholder="街道地址／门牌号">
                    ...
                    <div class="message clearfix">
                        ...
                        <div class="wz">
                            <?php echo isset($lng[0]) ? 'N' . $lng[0]. "&nbsp;&nbsp;" : '';?>
                            <?php echo isset($lng[1]) ? 'S' . $lng[1] : '';?>
                            <input type="hidden" name="resultlat" id='resultlat' value='{{ result }}' />
                        </div>
                    </div>
                    <div class="message clearfix">
                        <font>
                        ...
                        <div class="selectBox selectBox2 f-pr">
                            <select name="rainwater" class="select2">
                                ...
                                <option value="2">微干</option>
                                <option value="3">潮湿</option>
                                <option value="4">湿润</option>
                                <option value="5">涝灾</option>
                            </select>
                        </div>
                    </div>
                    <div class="message clearfix">
                        ...
                        <div class="inputBox inputBox3 f-pr clearfix">
                            <input class="input1 f-fl" type="text" name="plant_area"  id="plant_area" data-rule="required;xs" >
                    ...
                    <div class="message clearfix">
                        ...
                        <div class="inputBox inputBox2 f-pr clearfix">
                            <input readonly="readonly" type="text"  class="Wdate input1" name="product_date" id="product_date" onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'product_date\',{M:0,d:0})}'})"></em>
                    ...
                    <div class="message clearfix">
                        ...
                        <div class="inputBox inputBox3 f-pr clearfix">
                            <input type="text" name='expiration_date' class="input1 f-fl"/>
                            <i class="dw f-fl">天</i>
                        </div>
                    </div>
                    <div class="line"></div>
                    ...
                    <div class="message clearfix">
                        ...
                        <div class="inputBox inputBox2 f-pr clearfix">
                            <input class="input1 f-fl" type="text" name="breed">
                        </div>
                    </div>
                    <div class="message clearfix">
                        <font>
                        ...
                        <div class="inputBox inputBox3 f-pr clearfix">
                            <input class="input1 f-fl" type="text" name="neatness">
                            <i class="dw f-fl">%</i>
                        </div>
                    </div>
                    <div class="message clearfix">
                        ...
                        <div class="inputBox inputBox3 f-pr clearfix">
                            <input class="input1 f-fl" type="text" name="fineness">
                            <i class="dw f-fl">%</i>
                        </div>
                    </div>
                    <div class="message clearfix">
                        ...
                        <div class="inputBox inputBox3 f-pr clearfix">
                            <input class="input1 f-fl" type="text" name="sprout" >
                            <i class="dw f-fl">%</i>
                        </div>
                    </div>
                    <div class="message clearfix">
                        ...
                        <div class="inputBox inputBox3 f-pr clearfix">
                            <input class="input1 f-fl" type="text" name="water" >
                            <i class="dw f-fl">%</i>
                        </div>
                    </div>
                    <div class="message clearfix">
...
<script>
    $(function(){
        ...
        $('#applyForm').validator({
            ...
            fields: {
                'village': '产地:required;',
                'address': '产地:required;length_name;length[5~50];',
                'rainwater': '雨水等级:required;',
                //'plant_area': '种植面积:required;xs;',
        ...
        (function(){
            $('.addBox3 .btn').click(function(){
                ...
                var one_val_id=$(this).parent().find('.one option:selected').val();
                var two_val = $(this).parent().find('.two').val();
                var three_val = $(this).parent().find('.three').val();

                if(one_val && two_val && three_val){
                    var str = '<tr height="28"><input type="hidden" name="plantoperate_type[]" value='+ one_val_id +' ><input type="hidden" name="plantbegin_date[]" value=' + two_val +' ><input type="hidden" name="plantend_date[]" value='+ three_val +' ><td align="center">'+ one_val +'</td><td align="center">'+ two_val +'   ～  '+ three_val +'</td><td align="center"><a onclick="$(this).parents(\'tr\').remove();" href="javascript:;">删除</a></td></tr>';
                    $(str).appendTo($(this).parent().prev('table'));
