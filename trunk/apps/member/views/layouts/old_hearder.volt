...
<div class="header">
    ...
    <div class="menu w960 mtauto clearfix">
        ...
        <div class="hotLine f-fr">
            <img src="/mdg/images/header_hotLine.png" />
        </div>
    </div>
                ...
                <div class="fore">
                    ...
                    <div class="foreBox" style="top:0;">
                        <div class="erji">
                            {% for  key,val in  twocate %}
                                {% if val["parent_id"]== 2 %}
                                <a  href="javascript:;"    onmouseover="showtopcate3({{val['id']}})" {% if cate["2"] == val['id'] %} class="active" {% endif %} >
                                    {{val['title']}}
                                </a>
                                {% endif %}
                            {% endfor %}  
                    ...
                    <div class="foreBox" style="bottom:0;">
                        <div class="erji">
                           {% for  key,val in  twocate %}
                                ...
                                <a  href="javascript:;" onmouseover="showtopcate4({{val['id']}})" {% if cate["1377"] == val['id'] %} class="active" {% endif %} >
                                    {{val['title']}}
                                </a>
                                {% endif %}
                            {% endfor %}  
                    ...
                    <div class="foreBox" style="bottom:0;">
                        <div class="erji">
                             {% for  key,val in  twocate %}
                                ...
                                <a  href="javascript:;"    onmouseover="showtopcate4({{val['id']}})" {% if cate["899"] == val['id'] %} class="active" {% endif %} >
                                    {{val['title']}}
                                </a>
                                {% endif %}
                            {% endfor %}  
