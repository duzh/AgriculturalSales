					...
					<div class="box">
						...
						<div class="buyer-common" style="display:block;" >
							...
							<div class="message clearfix"> <font>姓名</font>
								<div class="input-box">
									<input type="text" name='user_name' value=''  data-rule="required;fuck;length[2~10];" />
						...
						<div class="buyer-common"  >
							...
							<div class="message clearfix">
								<font>公司名称</font>
								<div class="input-box">
									<input type="text" name='ent_company_name' data-rule="required;length_name;length[2~30];" />
							...
							<div class="message clearfix">
								<font>企业法人</font>
								<div class="input-box">
									<input type="text" name='ent_erprise_legal_person'  data-rule="required;fuck;length[2~10];" />
						...
						<!--	<div class="message clearfix">
							...
							<div class="message clearfix">
								<font>姓名</font>
								<div class="input-box">
									<input type="text" name='ent_contact_name'  data-rule="required;fuck;length[2~10];" />
						...
						<!--	<div class="message clearfix">
							...
							<div class="message clearfix">
								<font>工程师账号</font>
								<div class="input-box">
									<input type="text" name='seid' data-rule="required;mobile;"  />
								</div>
							</div>
