            ...
            <div class="center-right f-fr">
                <div class="form-attest">
                    ...
                    <div class="box">
                        ...
                        <div class="buyer-common"  id='member_buyer_0' style="display:block;" >
                            ...
                            <div class="loadImg-box">
                                <div class="imgs" id='user_show_bankcard_picture'></div>

                                <div class="file-btn">

                                    <input class="btn2" type="file" name='user_bankcard_picture' id='user_bankcard_picture'/>
                                    <input id="user_bankcard_picture_hide" style="width:1px;opacity:0;filter:alpha(opacity:0);" type="text" value=""  data-rule="required;"  data-target="#user_bankcard_picture_tip" /> <i id='user_bankcard_picture_tip' style="position:absolute; left:176px; top:-6px;"></i>
                        ...
                        <font>个人手持身份证照片</font>
                        <div class="loadImg-box">
                            <div class="imgs" id='user_show_person_picture'></div>
                            <div class="file-btn">

                                <input class="btn2" type="file"  name='user_person_picture' id='user_person_picture'/>
                                <input id="user_person_picture_hide" style="width:1px;opacity:0;filter:alpha(opacity:0);" type="text" value=""  data-rule="required;"  data-target="#user_person_picture_tip"  /> <i id='user_person_picture_tip' style="position:absolute; left:176px; top:-6px;"></i>
                    ...
                    <div class="message clearfix">
                        <font>身份证照</font>
                        <div class="loadImg-box">
                            <div class="imgs" id='user_show_idcard_picture'></div>
                            <div class="file-btn">
                    ...
                    <div class="message clearfix">
                        <font>身份证背面</font>
                        <div class="loadImg-box">
                            <div class="imgs" id='user_show_idcard_picture_back'></div>
                            <div class="file-btn">
                    ...
                    <div class="message clearfix">
                        ...
                        <div class="input-box short-input">
                            <input type="text" name='farm_areas'  data-rule="required;zdy;" data-rule-zdy="/^(([1-9]+)|([1-9]+[0-9])|([1-9]+[0-9]+)|([0-9]+\.[0-9]{1,2}))$/"   data-target="#user_farm_areas" />
                            <i>亩</i>
                    ...
                    <div class="message clearfix">
                        ...
                        <div class="loadImg-box">
                            <div class="imgs" style='width:1200px;border:solid 0px #e4e4e4' id='user_show_picture_path'>
                                <ul id='user_show_picture_path'></ul>
                            </div>
                            <div class="file-btn">
                                <input class="btn2" type="file"  name='user_picture_path' id='user_picture_path' data-rule="required;"/>
                                <input id="user_picture_path_hide" style="width:1px;opacity:0;filter:alpha(opacity:0);" type="text" value=""  data-rule="required;"  data-target="#user_picture_path_hide_tip" />
                                <i id='user_picture_path_hide_tip' style="position:absolute; left:176px; top:-6px;"></i>
                                <input type="hidden" id='user_picture_id_hidden' value='0' /> 
                            </div>
                        </div>
                    ...
                    <div class="message clearfix">
                        ...
                        <div class="loadImg-box">
                            ...
                            <div class="imgs"  style='width:1200px;border:solid 0px #e4e4e4' >
                                <ul id='user_show_picture_path_contact'></ul>
                            </div>
                            ...
                            <div class="file-btn">
                                ...
                                <input type="hidden" id='user_picture_contract_id_hidden' value='0' /> 
                    ...
                    <div class="message clearfix">
                        ...
                        <div class="input-box">
                            ...
                            <input readonly="readonly" type="text" class="Wdate" name="user_etime" id="d4332" onfocus="WdatePicker({dateFmt: 'yyyy-MM',minDate:'#F{$dp.$D(\'d4331\',{M:0,d:1});}'})" value="" data-rule="required;" data-target="#date_tip">
                            <i id='date_tip'></i>
                    ...
                    <div class="message clearfix">
                        <font>推荐人</font>
                        <div class="input-box">
                            <input type="text" name='seusername' data-rule="mobile"/>
                            （选填）
                        </div>
                ...
                <div class="buyer-common"  id='member_buyer_1'  style='display:none'>
                    ...
                    <div class="message clearfix">
                        <font>注册登记证号</font>
                        <div class="input-box">
                            <input type="text" name='ent_register_no' data-rule="required;wxxx"  data-rule-wxxx="[/^[0-9a-zA-Z]*$/g, '只能输入字母数字']" />
                        </div>
                    </div>
                    <div class="message clearfix">
                        <font>公司地址</font>
                    ...
                    <font>银行卡证明照</font>
                    <div class="loadImg-box">
                        <div class="imgs" id='ent_show_bankcard_picture'></div>
                        <div class="file-btn">
                ...
                <div class="message clearfix">
                    <font>个体工商营业执照</font>
                    <div class="loadImg-box">
                        <div class="imgs" id='ent_show_identity_picture_lic'></div>
                        <div class="file-btn">
                ...
                <div class="message clearfix">
                    <font>身份证照</font>
                    <div class="loadImg-box">
                        <div class="imgs" id='ent_show_idcard_picture'></div>
                        <div class="file-btn">
                ...
                <div class="message clearfix">
                    <font>身份证背面</font>
                    <div class="loadImg-box">
                        <div class="imgs" id='ent_show_idcard_picture_back'></div>
                        <div class="file-btn">
                ...
                <div class="message clearfix">
                    ...
                    <div class="loadImg-box">
                        <div class="imgs" style='width:1200px;border:solid 0px #e4e4e4' id='user_show_picture_path'>
                            <ul id='ent_show_picture_path'></ul>
                        </div>
                        <div class="file-btn">

                            <input class="btn2" type="file"  name='ent_picture_path' id='ent_picture_path' data-rule="required;"/>
                            <input type="hidden" id='ent_farm_id_hidden' value='0' /> 
                            <input type="hidden" id='ent_contract_id_hidden' value='0' />

                            <input id="ent_picture_path_hide" style="width:1px;opacity:0;filter:alpha(opacity:0);" type="text" value=""  data-rule="required;"  data-target="#ent_picture_path_hide_tip" />
                            <i id='ent_picture_path_hide_tip' style="position:absolute; left:176px; top:-6px;"></i>
                ...
                <div class="message clearfix">
                    ...
                    <div class="loadImg-box">
                        <div class="imgs" style='width:1200px;border:solid 0px #e4e4e4' >
                            <ul id='ent_show_picture_path_contact'></ul>
                        </div>
