                        ...
                        <div class="buyer-common"  id='member_buyer_0' {% if user.type == 0 %} style="display:block;" {% endif %}>
                            ...
                            <div class="message clearfix">
                                ...
                                <div class="loadImg-box">
                                    <div class="imgs" id='user_show_idcard_picture'>
                                        ...
                                        <li style="float:left;">
                                            <img src="{{ constant('IMG_URL')}}{{ bank.idcard_picture }}" width="120" height="145"></li>
                                        {% endif %}
                                    </div>
                                    <div class="file-btn">
                            ...
                            <div class="message clearfix">
                                ...
                                <div class="loadImg-box">
                                    <div class="imgs" id='user_show_idcard_picture_back'>
                                        ...
                                        <img src="{{ constant('IMG_URL')}}{{ bank.idcard_picture_back }}" width="120px;" height="145px;">{% endif %}</div>
                                    <div class="file-btn">
                                    ...
                                    <div class="imgs" style='width:1200px;border:solid 0px #e4e4e4'>
                                        <ul id='user_show_picture_path'>
											...
											<li id="dl_{{ key }}" style="float:left">
												<img src="{{ constant('IMG_URL')}}{{ item }}" width="120" height="145">
                            ...
                            <div class="message clearfix">
                                ...
                                <div class="input-box">
                                    ...
                                    <input readonly="readonly" type="text" class="Wdate" name="user_etime" id="d4332" onfocus="WdatePicker({dateFmt: 'yyyy-MM',minDate:'#F{$dp.$D(\'d4331\',{M:0,d:1});}',maxDate:'2099-12-30'})"  data-rule="required;" data-target="#date_tip" value="{% if farm and farm.year!='' and farm.month!='' %}{{ farm.year }}-{{ farm.month }}{% endif %}">
                                    <i id='date_tip'></i>
                        ...
                        <div class="buyer-common"  id='member_buyer_1'  {% if user.type != 0 %} style="display:block;" {% endif %}>
                            ...
                            <div class="message clearfix">
                                ...
                                <div class="loadImg-box">
                                    <div class="imgs" id='ent_show_identity_picture_lic'>
                                        ...
                                        <img src="{{ constant('IMG_URL')}}{{ bank.identity_picture_lic }}" width="120px;" height="145px;">{% endif %}</div>
                                    <div class="file-btn">
                            ...
                            <div class="message clearfix">
                                ...
                                <div class="loadImg-box">
                                    <div class="imgs" id='ent_show_idcard_picture'>
                                        {% if bank and bank.idcard_picture %}
                                        <img src="{{ constant("IMG_URL")}}{{ bank.idcard_picture }}" width="120px;" height="145px;">{% endif %}</div>
                                    <div class="file-btn">
                            ...
                            <div class="message clearfix">
                                ...
                                <div class="input-box" >
                                    ...
                                    <input readonly="readonly" type="text" class="Wdate" name="ent_etime" id="d4334" onfocus="WdatePicker({dateFmt: 'yyyy-MM',minDate:'#F{$dp.$D(\'d43313\',{M:0,d:1});}',maxDate:'2099-12-30'})" data-rule="required;" data-target="#dateent_tip" value="{% if farm and farm.year!='' and farm.month!='' %}{{ farm.year }}-{{ farm.month }}{% endif %}">
                                    <i id='dateent_tip'></i>
