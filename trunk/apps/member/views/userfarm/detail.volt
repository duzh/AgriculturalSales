...
<div class="wrapper">
	<div class="w1190 mtauto f-oh">
		<div class="bread-crumbs w1185 mtauto">
            <span>{{ partial('layouts/ur_here') }}认证申请</span>
        </div>
		<!-- 左侧 start-->
				...
				<div class="title f-oh">认证申请</div>
				   {% if users.status == 1 %}
					<div class="wms-certifi-success">
						<strong class="zt1">恭喜您，您申请认证已通过审核！</strong>
						<a class="btn1" {% if flag %} href="/member/userfarm/certification/{{ flag }}" {% endif %}>查看证书</a>
					</div>
					{% endif %}
					{% if users.status == 2 %}
					<!-- 状态2 -->
					<div class="wms-certifi-success">
						...
						<font>如有疑问，请拨打24小时客服电话 400-1188-365.</font>
						<div class="btns">
							<a class="btn1" href="/member/userfarm/{{ func }}/{{ users.credit_id }}">重新提交</a>
				...
				<div class="certifi-message">
							...
							<div class="message clearfix">
								...
								<div class="info-box">
									<ul class="gallery f-oh">
										<li class="f-fl">
											<a target="_blank" href="{{ constant('ITEM_IMG')}}{{ bank['idcard_picture']}}"><img src="{{ constant('ITEM_IMG')}}{{ bank['idcard_picture']}}" alt="" width="251px" height="141px"></a>
										</li>
										<li class="f-fl">
											<a target="_blank" href="{{ constant('ITEM_IMG')}}{{ bank['idcard_picture_back']}}"><img src="{{ constant('ITEM_IMG')}}{{ bank['idcard_picture_back']}}" alt="" width="251px" height="141px"></a>
										</li>
									</ul>
								</div>
							</div>
						...
						<div class="basic-info">
							...
							<div class="message clearfix">
								...
								<div class="info-box">
									<ul class="gallery f-oh">
										<li class="f-fl">
											<a target="_blank" href="{{ constant('ITEM_IMG')}}{{ bank['identity_picture_lic']}}"><img src="{{ constant('ITEM_IMG')}}{{ bank['identity_picture_lic']}}" alt="" width="251px" height="141px"></a>
										</li>
									</ul>
								</div>
							</div>
							<div class="message clearfix">
								...
								<div class="info-box">
									<ul class="gallery f-oh">
										<li class="f-fl">
											<a target="_blank" href="{{ constant('ITEM_IMG')}}{{ bank['identity_picture_org']}}"><img src="{{ constant('ITEM_IMG')}}{{ bank['identity_picture_org']}}" alt="" width="251px" height="141px"></a>
										</li>
									</ul>
								</div>
							</div>
							<div class="message clearfix">
								...
								<div class="info-box">
									<ul class="gallery f-oh">
										<li class="f-fl">
											<a target="_blank" href="{{ constant('ITEM_IMG')}}{{ bank['identity_picture_tax']}}"><img src="{{ constant('ITEM_IMG')}}{{ bank['identity_picture_tax']}}" alt="" width="251px" height="141px"></a>
										</li>
									</ul>
								</div>
							</div>
					...
					{% if param == 8 %}
						<div class="basic-info">
							...
							<div class="message clearfix">
								<font>土地使用年限：</font>
								<div class="info-box">{{ farm['start_year'] }}年{{ farm['start_month'] }}月-{{ farm['year'] }}年{{ farm['month'] }}月</div>
							</div>
							<div class="message clearfix">
								<font>农场简介：</font>
