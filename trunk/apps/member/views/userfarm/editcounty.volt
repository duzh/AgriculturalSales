					...
					<div class="message clearfix">
						...
						<div class="radioBox f-oh tabBtn">
							<label class="f-db f-fl f-oh">
								<input type="radio" name='member_type' value='0' {% if userinfo.type==0%}checked{% endif %}>
								<i>个体户</i>
							</label>
							<label class="f-db f-fl f-oh">
								<input type="radio" name='member_type' value='1' {% if userinfo.type==1%}checked{% endif %}>
								<i>企业</i>
							</label>
						</div>
					</div>
						<div class="tabChange" style="display:{% if userinfo.type==1%}none{% else %}block{% endif %};">
							<div class="message clearfix">
								<font>
									<i>*</i>姓名：
								</font>
								<div class="inputBox inputBox1 f-pr">
									<input name="user_name" class="input1" type="text" value="{% if userinfo%}{{userinfo.name ? userinfo.name : ''}}{% endif %}">
								</div>
							</div>
							<div class="message clearfix">
								<font>
								...
								<div class="inputBox inputBox1 f-pr">
									<input name="user_credit_no" class="input1" type="text" value="{% if userinfo %}{{userinfo.certificate_no ? userinfo.certificate_no : ''}}{% endif %}">
								</div>
							</div>
							<div class="message clearfix">
								<font>
								...
								<div class="inputBox inputBox1 f-pr">
									<input name="user_mobile" class="input1" type="text" value="{% if userinfo %}{{userinfo.phone ? userinfo.phone : ''}}{% endif %}">
								</div>
							</div>
							<div class="message clearfix">
								<font>
								...
								<div class="selectBox selectBox1 f-pr">
									...
									<select name='user_town_id' data-target="#address-yz" class="select1 mb10 selectAreas">
										<option value="">街道</option>
									</select>
									<div class="f-oh">
										<input name="user_address"  data-target="#address-yz" class="input1" type="text" value="{% if userinfo %}{{userinfo.address ? userinfo.address : ''}}{% endif %}"><i id="address-yz"></i>
									</div>
									<i id="address-yz"></i>
								</div>
							</div>
							...
							<div class="message clearfix">
								...
								<div class="selectBox selectBox1 f-pr">
									...
									<select name='user_bank_district_id' class="select1 selectAreasBank">
										<option value="">区／县</option>
									</select>
								</div>
							</div>
							<div class="message clearfix">
								...
								<div class="inputBox inputBox1 f-pr">
									<input name='user_bank_account' class="input1" type="text" value="{% if userbank %}{{userbank.bank_account ? userbank.bank_account : ''}}{% endif %}">
								</div>
							</div>
							<div class="message clearfix">
								<font>
								...
								<div class="inputBox inputBox1 f-pr">
									<input name="user_bank_cardno" class="input1" type="text" value="{% if userbank %}{{userbank.bank_cardno ? userbank.bank_cardno : ''}}{% endif %}">
								</div>
							</div> -->
							<div class="message clearfix">
								<font>
								...
								<div class="loadBox f-pr">
									...
									<input class="hideTxt" name="photo" id="user_idcard_picture_hide" type="text" value="{% if userbank.idcard_picture_back %}1{%else%}{% endif %}"  data-target="#user_idcard_picture_tip">
							...
							<div class="message clearfix">
								...
								<div class="loadBox f-pr">
									...
									<a class="link" href="{{ constant('STATIC_URL')}}/mdg/images/lodeImg_img3.jpg">查看样照</a>
									<input class="hideTxt" name="back-photo" id="user_idcard_picture_back_hide" style="width:1px;opacity:0;filter:alpha(opacity:0);" type="text" value="{% if userbank.idcard_picture_back %}1{%else%}{% endif %}"   data-target="#user_idcard_picture_back_tip">
							...
							<div class="message clearfix">
								...
								<div class="inputBox inputBox1 f-pr">
									<input name='senameid' class="input1" type="text" value="{% if userinfo %}{{userinfo.se_mobile ? userinfo.se_mobile : ''}}{% endif %}">
								</div>
							</div>
						</div>
						<div class="tabChange" style="display:{% if userinfo.type==0%}none{% else %}block{% endif %};">
							<div class="message clearfix">
								<font>
									<i>*</i>公司名称：
								</font>
								<div class="inputBox inputBox1 f-pr">
									<input name="ent_company_name" class="input1" type="text" value="{% if userinfo %}{{userinfo.company_name ? userinfo.company_name : ''}}{% endif %}">
								</div>
							</div>
							<div class="message clearfix">
								<font>
								...
								<div class="inputBox inputBox1 f-pr">
									<input name="ent_register_no" class="input1" type="text" value="{% if userinfo %}{{userinfo.register_no ? userinfo.register_no : ''}}{% endif %}">
								</div>
							</div>
							<div class="message clearfix">
								<font>
								...
								<div class="selectBox selectBox1 f-pr">
									...
									<select name='town_id' data-target="#address-yz1" class="select1 mb10 selectAreasCompany">
										<option value="">街道</option>
									</select>
									<div class="f-oh">
										<input name="ent_address" data-target="#address-yz1" class="input1" type="text" value="{% if userinfo %}{{userinfo.address ? userinfo.address : ''}}{% endif %}">
									</div>
									<i id="address-yz1"></i>
								</div>
							</div>
							<div class="message clearfix">
								...
								<div class="inputBox inputBox1 f-pr">
									<input name="ent_erprise_legal_person" class="input1" type="text" value="{% if userinfo %}{{userinfo.enterprise_legal_person ? userinfo.enterprise_legal_person : ''}}{% endif %}">
								</div>
							</div>
							<div class="message clearfix">
								<font>
								...
								<div class="inputBox inputBox1 f-pr">
									<input name="ent_certificate_no" class="input1" type="text" value="{% if userinfo %}{{userinfo.certificate_no ? userinfo.certificate_no : ''}}{% endif %}">
								</div>
							</div>
							<div class="line"></div>
							...
							<div class="message clearfix">
								...
								<div class="inputBox inputBox1 f-pr">
									<input name="ent_contact_name" class="input1" type="text" value="{% if usercontact %}{{usercontact.name ? usercontact.name : ''}}{% endif %}">
								</div>
							</div>
							<div class="message clearfix">
								<font>
								...
								<div class="inputBox inputBox1 f-pr">
									<input name="ent_contact_phone" class="input1" type="text" value="{% if usercontact%}{{usercontact.phone ? usercontact.phone : ''}}{% endif %}">
								</div>
							</div>
							<div class="message clearfix">
								<font>传真：</font>
								<div class="inputBox inputBox1 f-pr">
									<input class="input1" name="ent_contact_fax" type="text" value="{% if usercontact %}{{usercontact.fax ? usercontact.fax : ''}}{% endif %}">
								</div>
							</div>
							<div class="line"></div>
							<div class="m-title">认证信息</div>
							...
							<div class="message clearfix">
								...
								<div class="selectBox selectBox1 f-pr">
									...
									<select  class="select1 selectAreasCompanyBank" name='ent_bank_district_id'>
										<option value="">区／县</option>
									</select>
								</div>
							</div>
							<div class="message clearfix">
								...
								<div class="inputBox inputBox1 f-pr">
									<input name="ent_bank_account" class="input1" type="text" value="{% if userbank %}{{userbank.bank_account ? userbank.bank_account : ''}}{% endif %}">
								</div>
							</div>
							<div class="message clearfix">
								<font>
								...
								<div class="inputBox inputBox1 f-pr">
									<input name="ent_bank_cardno" class="input1" type="text" value="{% if userbank %}{{userbank.bank_cardno ? userbank.bank_cardno : ''}}{% endif %}">
								</div>
							</div> -->
							<div class="message clearfix">
								<font>
								...
								<div class="loadBox f-pr">
									...
									<input class="hideTxt" id="ent_identity_picture_lic_hide" name="gs-yezz" type="text" value="{% if userbank.identity_picture_lic %}1{% else %}{% endif %}" data-target="#ent_identity_picture_lic_tip" />
							...
							<div class="message clearfix">
								...
								<div class="loadBox f-pr">
									...
									<a class="link" href="{{ constant('STATIC_URL')}}/mdg/images/lodeImg_img4.jpg">查看样照</a>
									<input class="hideTxt" name="gs-jh-photo" id="ent_organization_code_hide"  type="text" value="{% if userbank.identity_picture_org %}1{% else %}{% endif %}" data-target="#ent_organization_code_tip" />
							...
							<div class="message clearfix">
								...
								<div class="loadBox f-pr">
									...
									<a class="link" href="{{ constant('STATIC_URL')}}/mdg/images/lodeImg_img4.jpg">查看样照</a>
									<input class="hideTxt" name="gs-dj-photo" id="ent_tax_registration_hide" style="width:1px;opacity:0;filter:alpha(opacity:0);" type="text" value="1" data-rule="required;"  data-target="#ent_tax_registration_tip" />
							...
							<div class="message clearfix">
								...
								<div class="loadBox f-pr">
									...
									<a class="link" href="{{ constant('STATIC_URL')}}/mdg/images/lodeImg_img3.jpg">查看样照</a>
									<input class="hideTxt" name="gs-photo" type="text" id="ent_idcard_picture_hide" value="{% if userbank.idcard_picture %}1{% else %}{% endif %}"  data-target="#ent_idcard_picture_tip">
							...
							<div class="message clearfix">
								...
								<div class="loadBox f-pr">
									...
									<a class="link" href="{{ constant('STATIC_URL')}}/mdg/images/lodeImg_img3.jpg">查看样照</a>
									<input class="hideTxt" id="ent_idcard_picture_back_hide" name="gs-back-photo" type="text" value="{% if userbank.idcard_picture_back %}1{% else %}{% endif %}" data-target="#ent_idcard_picture_back_tip" />
							...
							<div class="message clearfix">
								...
								<div class="inputBox inputBox1 f-pr">
									<input name='seid' class="input1" type="text" value="{% if userinfo %}{{userinfo.se_mobile? userinfo.se_mobile : ''}}{% endif%}" >
								</div>
		...
		$(function(){
			...
			$('#rolesForm').validator({
				...
				fields: {
			        ...
			        'user_address': '所在区域:required;length_name;length[3~50];',
			        ...
			        'ent_address': '公司地址:required;length_name;length[5~50];',
