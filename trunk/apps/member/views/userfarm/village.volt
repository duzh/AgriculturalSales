...
<div class="center-wrapper pb30">
	<div class="bread-crumbs w1185 mtauto">
		<a href="/">首页</a> > <a href="/member">个人中心</a> > 村级服务站
	</div>
	<div class="w1185 mtauto clearfix">
		...
		<!-- 左侧 end-->
			...
			<div class="center-right f-fr">
				<form action="/member/userfarm/villagesave" method="post" id='userForm'>
				<div class="form-attest">
					...
					<div class="box">
						...
						<div class="buyer-common" style="display:block;">
							...
							<div class="message clearfix">
								...
								<div class="select-box">
									...
									<select name='user_area_district_id'  class='user_area_selectAreas'>
										<option value=''>请选择</option>
									</select>
									<select  name='user_area_town_id' class='user_area_selectAreas' data-rule="required;remote[/member/userfarm/checkAreaVillage]" > 
										<option value=''>请选择</option>
									</select>
								</div>
							</div>
							...
							<div class="message clearfix">
								...
								<div class="loadImg-box">
									...
									<div class="file-btn">
										...
										<input id="user_idcard_picture_back_hide" style="width:1px;opacity:0;filter:alpha(opacity:0);" type="text" value=""  data-rule="required;"  data-target="#user_idcard_picture_back_hide1" />
                                        <i id='user_idcard_picture_back_hide1' style="position:absolute; left:176px; top:-6px;"></i>
						...
						<!-- 村站 企业 -->
						<div class="buyer-common" style="display:none;">
							...
							<div class="message clearfix">
								<font>企业法人</font>
								<div class="input-box">
									<input type="text" name='ent_erprise_legal_person' data-rule="required;" />
							...
							<div class="message clearfix">
								...
								<div class="select-box">
									...
									<select name='ent_area_district_id'  class='ent_area_selectAreas'>
										<option value=''>请选择</option>
									</select>
									<select  name='ent_area_town_id' class='ent_area_selectAreas' data-rule="required;remote[/member/userfarm/checkAreaVillage]" >
										<option value=''>请选择</option>
									</select>
