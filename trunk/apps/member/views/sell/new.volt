                ...
                {{ form("sell/create", "method":"post","id":"newsell") }}
                    ...
                    <div class="message clearfix">
                        ...
                        <div class="inputBox inputBox1 f-pr">
                            <input name="title"  class="input1" type="text">
                        </div>
                    </div>
                    <div class="message clearfix">
                        <font>
                        ...
                        <div class="selectBox selectBox1 f-pr">
                            ...
                            {% if user_info['lwtt'] %} <a style="display:inline-block; line-height:40px; color:#4471b8; min-width:143px; position:absolute; left:536px; top:0;" class="south-west-alt" title="分类中只会显示已整合的可信农场所成功发布的供应产品的分类，未成功发布的产品分类不会显示。" href="javascript:;">为什么有些分类没有显示</a>{% endif %}
                        </div>
                   ...
                   {% if user_info['maxcategory_id']  %}
                            ...
                            <div class="inputBox inputBox2 f-pr clearfix">
                                <div class="price-tabs clearfix">
                                    <label class="f-db f-fl f-oh">
                                        <input class="f-fl" type="radio" value="0" id="price_type_0" name="price_type" checked >
                                ...
                                <!--区间价格-->
                                <div class="inputBox inputBox2 f-pr clearfix ptype1" >
                                   <input name="min_price" data-target="#price-yz1" class="input2 ptype1" type="text" id="min_price" >
                                   <i class="heng ptype1">-</i>
                                   <input name="max_price" data-target="#price-yz2" class="input2 ptype1" type="text" id='max_price' ><i class="range f-fl" >元／<b class="add-unitChange">公斤</b></i>
                                    <i id="price-yz1"></i>
                                    <i id="price-yz2"></i>
                                </div>
                                <div class="price-changes clearfix ptype2 ">
                                    <!-- 增加价格区间 -->
                                    <div class="pc-left f-fl">
                                       ...
                                       <span class="msg-box" id="price-yz4" ></span>
                                        <a href="javascript:;" class="add-priceArea" id="add_step" >+增加价格区间</a>
                                    </div>
                                    <!-- 预览 -->
                                    <div class="pc-right f-fl f-oh">
                                        <div class="r-title f-fl">预<br />览</div>
                                        <!-- 数据为空时显示 -->
                                        <div class="r-list f-fl" id="showlist">
                                            <p>可根据买家采购的不同数量设置不同价格</p>
                                        </div>
                                        <!-- 有数据时显示样式 -->
                                        <div class="r-list f-fl" id="showlist1" style="display:none">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="message clearfix">
                        ...
                        <div class="inputBox inputBox2 f-pr clearfix">
                            <input  class="input1 f-fl" type="text" name="quantity" id="quantity">
                            <i class="range f-fl" id="quantity_1"><label>公斤</label>（0为不限）</i>
                        </div>
                    </div>
                    <div class="message clearfix" id="min_number_tip">
                        <font>
                            <i>*</i>起购量：
                        </font>
                        <div class="inputBox inputBox2 f-pr clearfix">
                            <input name="min_number" class="input1 f-fl" type="text"  id="min_number" >
                            <i class="range f-fl" id="min_number1">公斤</i>
                        </div>
                    </div>
                    <div class="message clearfix">
                        <font>
                    ...
                    <div class="message clearfix">
                        ...
                        <div class="inputBox inputBox3 f-pr clearfix">
                            <select class="select2" name="stime" id="s_stime" >
                    ...
                    <div class="message clearfix">
                        <font>品种：</font>
                        <div class="inputBox inputBox1 f-pr">
                            <input class="input1" type="text" name='breed' >
                        </div>
                    </div>
                    <div class="message clearfix">
                        <font>规格：</font>
                        <div class="inputBox f-pr clearfix" style="width:350px;">
                            <input class="input1 f-fl" type="text" name="spec" >
                    ...
                    <div class="message clearfix">
                        ...
                        <div class="areaBox f-pr">
                             <textarea name="content" id='editor' >
                               ...
                               <input type="text"  name="contenthidden" id='contenthidden' style="opacity:0;filter:alpha(opacity:0);"  data-target="#content-yz" >
                             <i id="content-yz"></i>
                        </div>
                    </div>
                    {% if publish_set and publish_set.publish_set == 3 %}
                    <div class="message clearfix">
                        <font>
                            <i>*</i>发布平台：
                        </font>
                        <div class="inputBox inputBox4 f-pr clearfix">
                            {% for key,val in plat %}
                                ...
                                <label class="f-db f-fl f-oh" style="margin-right:30px;">
                                    <input style="margin-right:10px; margin-top:14px;" class="f-fl" type="radio" name="plat" value="{{ key }}" {% if key == 0 %} checked {% endif %}/>
                    ...
                    <div class="message clearfix">
                        ...
                        <div class="inputBox inputBox4 f-pr clearfix">
                            ...
                            <img height="40" class="f-fl" src="/member/code/index" alt="" id='codeimg' onclick="javascript:this.src='/member/code/index?tm='+Math.random();" >
                    ...
                    {% endif %}
                     <div class="btns f-oh">
                            ...
                            <input class="post-btn f-fl" type="submit" value="确认发布">
...
jQuery(document).ready(function(){
    ...
    $('#newsell').validator({
        ...
        rules: {
            ...
            nimei0  : [/^([0-9])+(\.([0-9]){1,2})?$/, '小数点后支持2位'],
            intqutaily:[/^[1-9]\d*$/,'请输入正整数，如：“1”、“10”'],
            nimei  : [/^(0\.[0-9][1-9]*|[1-9]\d*(\.\d{1,2})?)$/, '格式有误'],
            checkNum: function () {
                switch ($('input[name="price_type"]:checked').val()){
                    case '0':
                    ...
                    for (var i = 0, j = els.length; i < j; i++){
                        if(els[0]&&els[1]){
                           if(els[0].value&&els[1].value&&parseInt(els[0].value)>=parseInt(els[1].value)){
                               ...
                               if(els[1].value&&els[2].value&&parseInt(els[1].value)>=parseInt(els[2].value)){
                                 return '购买数量必须大于上一区间';
                               }else{
                                 return true;
                               }
                        ...
                        if(els[0]&&els[1]){
                           if(els[0].value&&els[1].value&&parseFloat(els[0].value)<=parseFloat(els[1].value)){
                                  return '产品单价必须小于上一区间';
                                   ...
                                   if(els[1].value&&els[2].value&&parseFloat(els[1].value)<=parseFloat(els[2].value)){
                                         return '产品单价必须小于上一区间';
                                   }else{
                                         return true;
                                   }
        ...
        fields: {
          ...
          'min_price': '价格:required;nimei;checkMax[cz, max_price];length[~8]',
          'max_price': '价格:required;nimei;checkMax[scgt, min_price];length[~8]',
          'category':'商品类型:required',
          'photo':'产品照片:required;',
          'quantity':'供应量:required;float[*];nimei0;length[~8];checkNum;',
          'min_number':'起购量:required;float[+];nimei0;length[~8];checkNum',
          'contenthidden':'详细信息:required;checkImg',
          'img_yz':"验证码:required;remote[/member/code/checkvcoed ];",
          'step_quantity[]':"购买数量:required;intqutaily;checkstep_quantity;length[~8]",
          'step_price[]':"产品单价:required;nimei0;checkstep_price;length[~8]"
        }
    });
    setTimeout(function(){
          $('#img_upload').uploadify({
                ...
                'fileSizeLimit' : '2MB',
                'fileTypeExts' : '*.jpg;*.png;*.jpeg;*.bmp;*.png;*.gif',
                'formData' : {
                    'sid' : '{{ sid }}',
                    'type' : '1'
                },
                   ...
                   if(parseInt(step_quantity[0].value)>=parseInt(step_quantity[1].value)||parseFloat(step_price[0].value)<=parseFloat(step_price[1].value)){
                         ...
                         if(step_quantity[0].value==1&&step_quantity[1].value==2){
                             str='<tr height="30"><td align="center">'+step_quantity[0].value+'</td><td align="center"><i>'+step_price[0].value+'</i>元/<b class="add-unitChange">'+ unit +'</b></td></tr><tr height="30"><td align="center">'+step_quantity[1].value+'</td><td align="center"><i>'+step_price[1].value+'</i>元/<b class="add-unitChange">'+ unit +'</b></td></tr>';
                              ...
                              var view_quantity = (pirce != step_quantity[0].value)?step_quantity[0].value+"~"+pirce:step_quantity[0].value;
                              str='<tr height="30"><td align="center">'+view_quantity+'</td><td align="center"><i>'+step_price[0].value+'</i>元/<b class="add-unitChange">'+ unit +'</b></td></tr><tr height="30"><td align="center">≥'+step_quantity[1].value+'</td><td align="center"><i>'+step_price[1].value+'</i>元/<b class="add-unitChange">'+ unit +'</b></td></tr>';
                         }
                   }
               } 
          }
                      ...
                      // str='';
                         ...
                         if(step_quantity[0].value==1&&step_quantity[1].value==2&&step_quantity[2].value==3){
                             str='<tr height="30"><td align="center">'+step_quantity[0].value+'</td><td align="center"><i>'+step_price[0].value+'</i>元/<b class="add-unitChange">'+ unit +'</b></td></tr><tr height="30"><td align="center">'+step_quantity[1].value+'</td><td align="center"><i>'+step_price[1].value+'</i>元/<b class="add-unitChange">'+ unit +'</b></td></tr><tr height="30"><td align="center">≥'+step_quantity[2].value+'</td><td align="center"><i>'+step_price[2].value+'</i>元/<b class="add-unitChange">'+ unit +'</b></td></tr>';
                              ...
                              var view_quantity = (pirce != step_quantity[0].value)?step_quantity[0].value+"~"+pirce:step_quantity[0].value;
                              var view_quantity2 = (pirce2 != step_quantity[1].value)?step_quantity[1].value+"~"+pirce2:step_quantity[1].value;
                              str='<tr height="30"><td align="center">'+view_quantity+'</td><td align="center"><i>'+step_price[0].value+'</i>元/<b class="add-unitChange">'+ unit +'</b></td></tr><tr height="30"><td align="center">'+view_quantity2+'</td><td align="center"><i>'+step_price[1].value+'</i>元/<b class="add-unitChange">'+ unit +'</b></td></tr><tr height="30"><td align="center">≥'+step_quantity[2].value+'</td><td align="center"><i>'+step_price[2].value+'</i>元/<b class="add-unitChange">'+ unit +'</b></td></tr>';
                         }
...
(function(){
    ...
    $('.add-priceArea').click(function(){
        ...
        if(check_add_price){
            var str = '<tr height="44"><td><div class="n-box f-pr"><i>购买</i><input data-target="#price-yz' + i + '" type="text" name="step_quantity[]" onkeyup="check_price_quantity()" ><i><b class="add-unitChange">'+ unit +'</b>及以上</i><em class="jt-jgYz1" id="price-yz' + i + '"></em></div></td><td><div class="n-box f-pr"><input data-target="#price-yz' + (++i) + '" type="text" name="step_price[]" onkeyup="check_price_quantity()" ><i>元／<b class="add-unitChange">'+ unit +'</b></i><a href="javascript:;" onclick="delprice(this)">删除</a><em class="jt-jgYz2" id="price-yz' + (i++) + '"></em></div></td></tr>';
...
<style>
    ...
    #price-yz1 .n-ok .n-msg{ position:absolute; left:90px;top: 12px;}
    #price-yz2 .n-ok .n-msg{ position:absolute; left:214px;top: 12px;}
    #price-yz1 .n-error .n-msg{}
    #price-yz2 .n-error .n-msg{ position:absolute; left:124px;top: 45px;}
    .jt-jgYz1 .n-ok .n-msg{ position:absolute; left:108px; top:15px;}
    .jt-jgYz2 .n-ok .n-msg{ position:absolute; left:84px; top:15px;}
    .jt-jgYz1 .n-error .n-msg{ position:absolute; bottom:4px; left:15px;}
    .jt-jgYz2 .n-error .n-msg{ position:absolute; left:19px; bottom:4px;}
    .post-offer .message .pc-left .n-box{ padding-bottom:15px;}
