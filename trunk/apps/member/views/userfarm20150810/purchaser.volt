					...
					<div class="box">
						...
						<div class="buyer-common" style="display:block;">
							...
							<div class="message clearfix">
								<font>身份证号</font>
								<div class="input-box">
									<input type="text" name='user_certificate_no' value=''  data-rule="required;ID_card;" />
							...
							<div class="message clearfix">
								<font>手机号</font>
								<div class="input-box">
									<input type="text" name='user_mobile' data-rule="required;mobile;" />
								</div>
							</div>
							<div class="message clearfix">
								<font>所在区域</font>
						...
						<div class="buyer-common">
                            ...
                            <div class="message clearfix">
								<font>组织机构代码证</font>
								<div class="loadImg-box">
									<div class="imgs" id='ent_show_identity_picture_org'></div>
									<div class="file-btn">
                            ...
                            <div class="message clearfix">
								<font>税务登记证（选填）</font>
								<div class="loadImg-box">
									<div class="imgs" id='ent_show_identity_picture_tax'></div>
									<div class="file-btn">
