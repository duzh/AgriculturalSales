							...
							<div class="message clearfix">
								...
								<div class="loadImg-box">
									<div class="imgs" id='user_show_idcard_picture'>
                                        ...
                                        <img style="width: 119px;height: 144px" src="{{userbank['idcard_picture']}}" />
                                        {% endif %}
										</div>
									<div class="file-btn">
							...
							<div class="message clearfix">
								...
								<div class="loadImg-box">
									<div class="imgs" id='user_show_idcard_picture_back'>
                                        ...
                                        <img style="width: 119px;height: 144px" src="{{userbank['idcard_picture_back']}}" />
                                        {% endif %}
										</div>
									<div class="file-btn">
							...
							<div class="message clearfix">
								...
								<div class="loadImg-box">
									<div class="imgs" id='ent_show_identity_picture_lic'>
                                        ...
                                        <img style="width: 119px;height: 144px" src="{{userbank['identity_picture_lic']}}" />
                                        {% endif %}
										</div>
									<div class="file-btn">
                            ...
                            <div class="message clearfix">
								...
								<div class="loadImg-box">
									<div class="imgs" id='ent_show_identity_picture_org'>
                                        ...
                                        <img style="width: 119px;height: 144px" src="{{userbank['identity_picture_org']}}" />
                                        {% endif %}
                                    </div>
									<div class="file-btn">
                            ...
                            <div class="message clearfix">
								...
								<div class="loadImg-box">
									<div class="imgs" id='ent_show_identity_picture_tax'>
                                        ...
                                        <img style="width: 119px;height: 144px" src="{{userbank['identity_picture_tax']}}" />
                                        {% endif %}
                                    </div>
									<div class="file-btn">
