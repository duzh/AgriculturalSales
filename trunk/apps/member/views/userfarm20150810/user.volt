            ...
            <div class="center-right f-fr">
                ...
                <div class="message clearfix">
                    ...
                    <div class="input-box" >
                        ...
                        <input readonly="readonly" type="text" class="Wdate" name="ent_etime" id="d4334" onfocus="WdatePicker({dateFmt: 'yyyy-MM',minDate:'#F{$dp.$D(\'d43313\',{M:0,d:1});}'})" value="" data-rule="required;" data-target="#dateent_tip">
                        <i id='dateent_tip'></i>
