        ...
        <!-- 申请开通店铺 start -->
         <div class="open_shop">
            ...
            <div class="formVal clearfix mt20">
                ...
                <div class="formBox clearfix">
                    <label>
                        <font class="label_bc"></font>申请负责区域：
                    </label>
                    <div class="inputBtn"> 
                        <input type="button" value="选择" onclick="javascript:newService('newaddress', '申请负责区域', '/member/dialog/newaddress?province={{province}}&city={{city}}&distinct={{distinct}}&town={{town}}');"/>
                        <input type="hidden" name='service_area' id='service_area' value='{{ town }}' >
                <br>
                        <font id='showAreas'>
                            <table style="border:solid 1px #ccc; width:50%; margin-top:10px;" >

                            {% for key,val in Viewareas %}
                                <tr height="30">
                                    
                                    <td style="text-align:left; font-size:12px;">{{val}}</td>
                                </tr>
                            {% endfor %}
                            </table>
                        </font>
                                ...
                                <div class="fileBtn">
                                    <div class="imgBox" >
                                        ...
                                        <ul class="gallery">
                                            <li>
                                                <a href="">
                                                    <img src="{{ constant("IMG_URL")}}/{{ shop.credit.personal_logo_picture}}" id="personal_logo_pictureshow_img-geti" width="125px" height="95px"/>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                                ...
                                <div class="fileBtn">
                                    <div class="imgBox" >
                                        ...
                                        <ul class="gallery">
                                            ...
                                            <li><a href="#"><img src=""  style="opacity:0; filter:alpha(opacity:0);"/></a></li>
                                        </ul>
                                    </div>
                                    <div class="btn">
                                ...
                                <div class="fileBtn">
                                    <div class="imgBox" >
                                        <ul class="gallery">
                                            <li>
                                                <a href="">
                                                    <img src="{{ constant('ITEM_IMG') }}{{ shop.credit ? shop.credit.personal_logo_picture : ''}}" id="logo_pictureshow_img-geti" width="125px" height="95px"/>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
         ...
         <div class="introduce_shop pb20">
            <h6 class="f-fs14 pl20">
                {% if shop.user_type == 2 %}
                <font id='onete' >个体户介绍</font>
                {% endif %}
                {% if shop.user_type == 3 %}
                <font id='onete' >企业介绍</font>
                {% endif %}
...
$('#newshop').validator({
        ...
        fields:  {
             shop_name:"企业名称:required;nimei;remote[/member/ajax/checkservice]",
