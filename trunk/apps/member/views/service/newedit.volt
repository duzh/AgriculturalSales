...
<div class="personal_center w960 mb20">
    ...
    <div class="center_right f-fr">
        ...
        <div class="open_shop">
            ...
            <div class="formVal clearfix mt20">
                    ...
                    <div class="userBox">
                        ...
                        <div class="selectBox">
                            <select id="jiaose" class="user_jiao" name="business_type" >
                                ...
                                <option value="{{key}}" {% if key == shop.user_type %} selected{% endif %} >{{val}}</option>
                                {% endfor %}
                            </select>
                            <input id="hidVal" style="width:1px;opacity:0;filter:alpha(opacity:0);" type="text" value="{{ shop.user_type}}" />
                        </div>
                        <!-- 下拉框 end --> </div>
                </div>
                <div class="formBox clearfix">
                    ...
                    <div class="goodsTxt">
                        <input type="text"  name="main_product1" <?php if(isset($shopgoods[0])){ echo "value='".$shopgoods[0]['goods_name']."'";}?>
                        data-rule="主营产品:zw;" data-target="#main_product_tip" />
                        <input type="text"  name="main_product2" <?php if(isset($shopgoods[1])){ echo "value='".$shopgoods[1]['goods_name']."'";}?>
                        data-rule="主营产品:zw;" data-target="#main_product_tip" />
                        <input type="text"  name="main_product3" <?php if(isset($shopgoods[2])){ echo "value='".$shopgoods[2]['goods_name']."'";}?>
                        data-rule="主营产品:zw;" data-target="#main_product_tip" />
                        <input type="text"  name="main_product4" <?php if(isset($shopgoods[3])){ echo "value='".$shopgoods[3]['goods_name']."'";}?>
                        data-rule="主营产品:zw;" data-target="#main_product_tip" />
                        <input type="text"  name="main_product5" <?php if(isset($shopgoods[4])){ echo "value='".$shopgoods[4]['goods_name']."'";}?>
                        data-rule="主营产品:zw;" data-target="#main_product_tip" /> <i id="main_product_tip"></i>
                    </div>
                </div>
                <div class="formBox clearfix">
                    <label>
                ...
                <div class="formBox clearfix">
                    ...
                    <div class="inputBtn">
                        <input type="button" value="选择" onclick="javascript:newWindows('newaddress', '申请负责区域', '/member/dialog/newaddress?province={{province}}&city={{city}}&distinct={{distinct}}&town={{town}}');"/>
                ...
                <div class="formCert clearfix"  style="display:none;{% if shop.user_type == 2 %} display:block; {% endif %}"   >
                    ...
                    <div class="certBox clearfix">
                        ...
                        <div class="addImgBox clearfix">
                                ...
                                <div class="fileBtn">
                                    <div class="imgBox" >
                                        ...
                                        <ul class="gallery">
                                            <li>
                                                <a href="">
                                                    <img src="{{ shop.credit.identity_card_front}}" id="bank_card_pictureshow_img-geti" width="125px" height="95px"/>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                            ...
                            <div class="addImg_tip f-fl">
                                <input id="bank_card_pictureshow_img-geti-hide" style="width:1px;opacity:0;filter:alpha(opacity:0);" type="text" value="<?php if(isset($shop->credit->bank_card_picture)&&$shop->credit->bank_card_picture){ echo 1;}?>" data-rule="预览图:required;" data-target="#bank_card_pictureshow_img-geti-tip" />
                    ...
                    <div class="certBox clearfix">
                        ...
                        <div class="addImgBox clearfix">
                                ...
                                <div class="fileBtn">
                                    <div class="imgBox">
                                        ...
                                        <ul class="gallery">
                                            <li>
                                                <a href="">
                                                    <img src="{{ shop.credit.identity_picture_lic}}"  id="identity_picture_licshow_img-geti" width="125px" height="95px" />
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                            ...
                            <div class="addImg_tip f-fl">
                                <input id="identity_picture_licshow_img-geti-hide" style="width:1px;opacity:0;filter:alpha(opacity:0);" type="text" value="<?php if(isset($shop->credit->identity_picture_lic)&&$shop->credit->identity_picture_lic){ echo 1;}?>" data-rule="预览图:required;" data-target="#identity_picture_licshow_img-geti-tip" />
                    ...
                    <div class="certBox clearfix">
                        ...
                        <div class="addImgBox clearfix">
                                ...
                                <div class="fileBtn">
                                    <div class="imgBox">
                                        ...
                                        <ul class="gallery">
                                            <li>
                                                <a href="">
                                                    <img src="{{ shop.credit ? shop.credit.identity_card_front : ''}}" id="identity_card_frontshow_img-geti" width="125px" height="95px"  />
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                            ...
                            <div class="addImg_tip f-fl">
                                <input id="identity_card_frontshow_img-geti-hide" style="width:1px;opacity:0;filter:alpha(opacity:0);" type="text" value="<?php if(isset($shop->credit->identity_card_front)&&$shop->credit->identity_card_front){ echo 1;}?>" data-rule="预览图:required;" data-target="#identity_card_frontshow_img-geti-tip" />
                    ...
                    <div class="certBox clearfix">
                        ...
                        <div class="addImgBox clearfix">
                                ...
                                <div class="fileBtn">
                                    <div class="imgBox">
                                        ...
                                        <ul class="gallery">
                                            <li>
                                                <a href="">
                                                    <img src="{{ shop.credit ? shop.credit.identity_card_back : ''}}" id="identity_card_backshow_img-geti"  width="125px" height="95px" />
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                            ...
                            <div class="addImg_tip f-fl">
                                <input id="identity_card_backshow_img-geti-hide" style="width:1px;opacity:0;filter:alpha(opacity:0);" type="text" value="<?php if(isset($shop->credit->identity_card_back)&&$shop->credit->identity_card_back){ echo 1;}?>" data-rule="预览图:required;" data-target="#identity_card_backshow_img-geti-tip" />
                ...
                <div class="formCert clearfix" style="display:none;{% if shop.user_type == 3 %} display:block;{% endif %}"   >
                    ...
                    <div class="certBox clearfix">
                        ...
                        <div class="addImgBox clearfix">
                                ...
                                <div class="fileBtn">
                                    <div class="imgBox">
                                        ...
                                        <ul class="gallery">
                                            <li>
                                                <a href="">
                                                    <img src="{{ shop.credit ? shop.credit.bank_card_picture : ''}}" id="bank_card_pictureshow_img-qiye" width="125px" height="95px" />
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                            ...
                            <div class="addImg_tip f-fl">
                                <input id="bank_card_pictureshow_img-qiye-hide" style="width:1px;opacity:0;filter:alpha(opacity:0);" type="text" value="<?php if(isset($shop->
                                credit->bank_card_picture)&&$shop->credit->bank_card_picture){ echo 1;}?>" data-rule="预览图:required;" data-target="#bank_card_pictureshow_img-qiye-tip" />
                    ...
                    <div class="certBox clearfix">
                        ...
                        <div class="addImgBox clearfix">
                                ...
                                <div class="fileBtn">
                                    <div class="imgBox">
                                        ...
                                        <ul class="gallery">
                                            <li>
                                                <a href="">
                                                    <img src="{{ shop.credit ? shop.credit.identity_picture_lic : ''}}" id="identity_picture_licshow_img-qiye" width='125px' height='95px'/>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                            ...
                            <div class="addImg_tip f-fl">
                                <input id="identity_picture_licshow_img-qiye-hide" style="width:1px;opacity:0;filter:alpha(opacity:0);" type="text" value="<?php if(isset($shop->
                                credit->identity_picture_lic)&&$shop->credit->identity_picture_lic){ echo 1;}?>" data-rule="预览图:required;" data-target="#identity_picture_licshow_img-qiye-tip" />
                    ...
                    <div class="certBox clearfix">
                        ...
                        <div class="addImgBox clearfix">
                                ...
                                <div class="fileBtn">
                                    <div class="imgBox">
                                        ...
                                        <ul class="gallery">
                                            <li>
                                                <a href="">
                                                    <img src="{{ shop.credit ? shop.credit.tax_registration : ''}}"  id="tax_registrationshow_img" width='125px' height='95px'/>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                            ...
                            <div class="addImg_tip f-fl">
                                <input id="tax_registrationshow_img-hide" style="width:1px;opacity:0;filter:alpha(opacity:0);" type="text" value="<?php if(isset($shop->credit->tax_registration)&&$shop->credit->tax_registration){ echo 1;}?>" data-rule="预览图:required;" data-target="#tax_registrationshow_img-tip" />
                    ...
                    <div class="certBox clearfix">
                        ...
                        <div class="addImgBox clearfix">
                                ...
                                <div class="fileBtn">
                                    <div class="imgBox">
                                        ...
                                        <ul class="gallery">
                                            <li>
                                                <a href="">
                                                    <img src="{{ shop.credit ? shop.credit.organization_code : ''}}" id="organization_codeshow_img"  width='125px' height='95px' />
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                            ...
                            <div class="addImg_tip f-fl">
                                <input id="organization_codeshow_img-hide" style="width:1px;opacity:0;filter:alpha(opacity:0);" type="text" value="<?php if(isset($shop->credit->organization_code)&&$shop->credit->organization_code){ echo 1;}?>" data-rule="预览图:required;" data-target="#organization_codeshow_img-tip" />
                    ...
                    <div class="certBox clearfix">
                        ...
                        <div class="addImgBox clearfix">
                                ...
                                <div class="fileBtn">
                                    <div class="imgBox">
                                        ...
                                        <ul class="gallery">
                                            <li>
                                                <a href="">
                                                    <img src="{{ shop.credit ? shop.credit.identity_card_front : ''}}"  id="identity_card_frontshow_img-qiye" width='125px' height='95px'  />
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                            ...
                            <div class="addImg_tip f-fl">
                                <input id="identity_card_frontshow_img-qiye-hide" style="width:1px;opacity:0;filter:alpha(opacity:0);" type="text" value="<?php if(isset($shop->credit->identity_card_front)&&$shop->credit->identity_card_front){ echo 1;}?>" data-rule="预览图:required;" data-target="#identity_card_frontshow_img-qiye-tip" />
                    ...
                    <div class="certBox clearfix">
                        ...
                        <div class="addImgBox clearfix">
                                ...
                                <div class="fileBtn">
                                    <div class="imgBox">
                                        ...
                                        <ul class="gallery">
                                            <li>
                                                <a href="">
                                                    <img src="{{ shop.credit ? shop.credit.identity_card_back : ''}}" id="identity_card_backshow_img-qiye" width='125px' height='95px' />
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                            ...
                            <div class="addImg_tip f-fl">
                                <input id="identity_card_backshow_img-qiye-hide" style="width:1px;opacity:0;filter:alpha(opacity:0);" type="text" value="<?php if(isset($shop->credit->identity_card_back)&&$shop->credit->identity_card_back){ echo 1;}?>" data-rule="预览图:required;" data-target="#identity_card_backshow_img-qiye-tip" />
        ...
        <div class="introduce_shop pb20">
            <h6 class="f-fs14 pl20">个人介绍</h6>
            <script id="editor" type="text/plain" style="height:500px;" name="shop_desc" >{{ shop.credit ? shop.credit.shop_desc : ''}} </script>
...
$(".selectAreas").ld({ajaxOptions : {"url" : "/ajax/getareasfull"},
    defaultParentId : 0,
    <?php if(isset($curAreas)&&$curAreas){?>
    texts : [{{ curAreas }}],
    <?php } ?>
    style : {"width" : 102}
});
jQuery(document).ready(function(){
    ...
    //银行正面照personal_logo_pictureshow_img-geti-tip
