                ...
                <li>
                    ...
                    <div class="message">
                        <em>
                            ...
                            <ul class="gallery">
                                <li style=" padding-left:0; margin-top:0; margin-left:0; font-size:12px;">
                                    <a href="{{shop.credit.identity_card_front}}">
                                        <img src="{{shop.credit.identity_card_front}}" width="125px" height="95px"  />
                                    </a>
                                </li>
                                <li><a href="#"><img src="" /></a></li>
                ...
                <li>
                    ...
                    <div class="message">
                        <em>
                            ...
                            <ul class="gallery">
                                <li style=" padding-left:0; margin-top:0; margin-left:0; font-size:12px;">
                                    <a href="{{shop.credit.bank_card_picture}}">
                                        <img src="{{shop.credit.bank_card_picture}}" width="125px" height="95px"  />
                                    </a>
                                </li>
                                <li><a href="#"><img src="" /></a></li>
                ...
                <li>
                    ...
                    <div class="message">
                        <em>
                            ...
                            <ul class="gallery">
                                <li style=" padding-left:0; margin-top:0; margin-left:0; font-size:12px;">
                                    <a href="{{shop.credit.identity_card_back}}">
                                        <img src="{{shop.credit.identity_card_back}}" width="125px" height="95px"  />
                                    </a>
                                </li>
                                <li><a href="#"><img src="" /></a></li>
                ...
                <li>
                    ...
                    <div class="message">
                        <em>
                            ...
                            <ul class="gallery">
                                <li style=" padding-left:0; margin-top:0; margin-left:0; font-size:12px;">
                                    <a href="{{shop.credit.identity_picture_lic}}">
                                        <img src="{{shop.credit.identity_picture_lic}}" width="125px" height="95px"  />
                                    </a>
                                </li>
                                <li><a href="#"><img src="" /></a></li>
                ...
                <li>
                    ...
                    <div class="message">
                        <em>
                            ...
                            <ul class="gallery">
                                <li style=" padding-left:0; margin-top:0; margin-left:0; font-size:12px;">
                                    <a href="{{shop.credit.tax_registration}}">
                                        <img src="{{shop.credit.tax_registration}}" width="125px" height="95px"  />
                                    </a>
                                </li>
                                <li><a href="#"><img src="" /></a></li>
                ...
                <li>
                    ...
                    <div class="message">
                        <em>
                            ...
                            <ul class="gallery">
                                <li style=" padding-left:0; margin-top:0; margin-left:0; font-size:12px;">
                                    <a href="{{shop.credit.organization_code}}">
                                        <img src="{{shop.credit.organization_code}}" width="125px" height="95px"  />
                                    </a>
                                </li>
                                <li><a href="#"><img src="" /></a></li>
