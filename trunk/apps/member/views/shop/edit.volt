                ...
                <div class="formCert clearfix" style="display:none;{% if shop.user_type == 1 %}display:block; {% endif %}">
                    ...
                    <div class="certBox clearfix">
                        ...
                        <div class="addImgBox clearfix">
                            ...
                            <div class="addImg_tip f-fl">
                                ...
                                value="{% if shop.user_type == 1 %}{%if shop.credit and shop.credit.bank_card_picture %}{{ constant('IMG_URL') }}{{shop.credit.bank_card_picture}}{% endif %}{% endif %}" data-rule="预览图:required;" data-target="#bank_card_pictureshow_img-tip" />
                    ...
                    <div class="certBox clearfix">
                        ...
                        <div class="addImgBox clearfix">
                            ...
                            <div class="addImg_tip f-fl">
                                <input id="identity_picture_licshow_img-hide" style="width:1px;opacity:0;filter:alpha(opacity:0);" type="text" value="{% if shop.user_type == 1 %}{%if shop.credit and shop.credit.identity_picture_lic %}{{ constant('IMG_URL') }}{{shop.credit.identity_picture_lic}}{% endif %}{% endif %}" data-rule="预览图:required;" data-target="#identity_picture_licshow_img-tip" />
                    ...
                    <div class="certBox clearfix">
                        ...
                        <div class="addImgBox clearfix">
                            ...
                            <div class="addImg_tip f-fl">
                                <input id="identity_card_frontshow_img-hide" style="width:1px;opacity:0;filter:alpha(opacity:0);" type="text" value="{% if shop.user_type == 1 %}{{ constant('IMG_URL') }}{%if shop.credit and shop.credit.identity_card_front %}{{ constant('IMG_URL') }}{{shop.credit.identity_card_front}}{% endif %}{% endif %}" data-rule="预览图:required;" data-target="#identity_card_frontshow_img-tip" />
                ...
                <div class="formCert clearfix" style="display:none;{% if shop.user_type == 2 %}display:block; {% endif %}">
                    ...
                    <div class="certBox clearfix">
                        ...
                        <div class="addImgBox clearfix">
                            ...
                            <div class="addImg_tip f-fl">
                                <input id="bank_card_pictureshow_img-geti-hide" style="width:1px;opacity:0;filter:alpha(opacity:0);" type="text" value="{% if shop.user_type == 2 %}{% if shop.credit and shop.credit.bank_card_picture %}{{ constant('IMG_URL') }}{{shop.credit.bank_card_picture}}{% endif %}{% endif %}" data-rule="预览图:required;" data-target="#bank_card_pictureshow_img-geti-tip" />
                    ...
                    <div class="certBox clearfix">
                        ...
                        <div class="addImgBox clearfix">
                            ...
                            <div class="addImg_tip f-fl">
                                <input id="identity_picture_licshow_img-geti-hide" style="width:1px;opacity:0;filter:alpha(opacity:0);" type="text" value="{% if shop.user_type == 2 %}{% if shop.credit and shop.credit.identity_picture_lic %}{{ constant('IMG_URL') }}{{shop.credit.identity_picture_lic}}{% endif %}{% endif %}" data-rule="预览图:required;" data-target="#identity_picture_licshow_img-geti-tip" />
                    ...
                    <!-- 身份证正面照 start -->
                      <div class="certBox clearfix">
                        ...
                        <div class="addImgBox clearfix">
                            <div class="lodeImg clearfix f-fl">
                                <div class="fileBtn">
                                    <div class="imgBox">
                                        ...
                                        <ul class="gallery">
                                            <li>
                                                <a href="{% if shop.user_type == 2 %}{%if shop.credit and shop.credit.identity_card_front %}{{ constant('IMG_URL') }}{{shop.credit.identity_card_front}}{% endif %}{% endif %}">
                            ...
                            <div class="addImg_tip f-fl">
                                <input id="identity_card_frontshow_img-geti-hide" style="width:1px;opacity:0;filter:alpha(opacity:0);" type="text" value="{% if shop.user_type == 2 %}{%if shop.credit and shop.credit.identity_card_front %}{{ constant('IMG_URL') }}{{shop.credit.identity_card_front}}{% endif %}{% endif %}" data-rule="预览图:required;" data-target="#identity_card_frontshow_img-geti-tip" />
                    ...
                    <div class="certBox clearfix">
                        ...
                        <div class="addImgBox clearfix">
                            ...
                            <div class="addImg_tip f-fl">
                                <input id="identity_card_backshow_img-geti-hide" style="width:1px;opacity:0;filter:alpha(opacity:0);" type="text" value="{% if shop.user_type == 2 %}{%if shop.credit and shop.credit.identity_card_back %}{{ constant('IMG_URL') }}{{shop.credit.identity_card_back}}{% endif %}{% endif %}" data-rule="预览图:required;" data-target="#identity_card_backshow_img-geti-tip" />
                ...
                <div class="formCert clearfix" style="display:none;{% if shop.user_type == 3 %} display:block; {% endif %}"  >
                    ...
                    <div class="certBox clearfix">
                        ...
                        <div class="addImgBox clearfix">
                            ...
                            <div class="addImg_tip f-fl">
                                <input id="bank_card_pictureshow_img-qiye-hide" style="width:1px;opacity:0;filter:alpha(opacity:0);" type="text" value="{% if shop.user_type == 3 %}{% if shop.credit and shop.credit.bank_card_picture %}{{ constant('IMG_URL') }}{{shop.credit.bank_card_picture}}{% endif %}{% endif %}" data-rule="预览图:required;" data-target="#bank_card_pictureshow_img-qiye-tip" />
                    ...
                    <div class="certBox clearfix">
                        ...
                        <div class="addImgBox clearfix">
                            ...
                            <div class="addImg_tip f-fl">
                                <input id="identity_picture_licshow_img-qiye-hide" style="width:1px;opacity:0;filter:alpha(opacity:0);" type="text" value="{% if shop.user_type == 3 %}{%if shop.credit and shop.credit.identity_picture_lic %}{{ constant('IMG_URL') }}{{shop.credit.identity_picture_lic}}{% endif %}{% endif %}" data-rule="预览图:required;" data-target="#identity_picture_licshow_img-qiye-tip" />
                    ...
                    <div class="certBox clearfix">
                        ...
                        <div class="addImgBox clearfix">
                            ...
                            <div class="addImg_tip f-fl">
                                <input id="tax_registrationshow_img-hide" style="width:1px;opacity:0;filter:alpha(opacity:0);" type="text" value="{% if shop.user_type == 3 %}{%if shop.credit and shop.credit.tax_registration %}{{ constant('IMG_URL') }}{{shop.credit.tax_registration}}{% endif %}{% endif %}" data-rule="预览图:required;" data-target="#tax_registrationshow_img-tip" />
                    ...
                    <div class="certBox clearfix">
                        ...
                        <div class="addImgBox clearfix">
                            ...
                            <div class="addImg_tip f-fl">
                                <input id="organization_codeshow_img-hide" style="width:1px;opacity:0;filter:alpha(opacity:0);" type="text" value="{% if shop.user_type == 3 %}{%if shop.credit and shop.credit.organization_code %}{{ constant('IMG_URL') }}{{shop.credit.organization_code}}{% endif %}{% endif %}" data-rule="预览图:required;" data-target="#organization_codeshow_img-tip" />
                    ...
                    <div class="certBox clearfix">
                        ...
                        <div class="addImgBox clearfix">
                            ...
                            <div class="addImg_tip f-fl">
                                <input id="identity_card_frontshow_img-qiye-hide" style="width:1px;opacity:0;filter:alpha(opacity:0);" type="text" value="{% if shop.user_type == 3 %}{%if shop.credit and shop.credit.identity_card_front %}{{ constant('IMG_URL') }}{{shop.credit.identity_card_front}}{% endif %}{% endif %}" data-rule="预览图:required;" data-target="#identity_card_frontshow_img-qiye-tip" />
                    ...
                    <div class="certBox clearfix">
                        ...
                        <div class="addImgBox clearfix">
                            ...
                            <div class="addImg_tip f-fl">
                                <input id="identity_card_backshow_img-qiye-hide" style="width:1px;opacity:0;filter:alpha(opacity:0);" type="text" value="{% if shop.user_type == 3 %}{%if shop.credit and shop.credit.identity_card_back %}{{ constant('IMG_URL') }}{{shop.credit.identity_card_back}}{% endif %}{% endif %}" data-rule="预览图:required;" data-target="#identity_card_backshow_img-qiye-tip" />
