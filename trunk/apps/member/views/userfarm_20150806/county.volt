					...
					<div class="box">
						...
						<div class="buyer-common" style="display:block;" >
							...
							<div class="message clearfix">
								<font>工程师账号</font>
								<div class="input-box">
									<input type="text" name='seusername'  data-rule="required;mobile;remote[/member/userfarm/checkCounty]" />
								</div>
							</div>
						...
						<div class="buyer-common"  >
							...
							<div class="message clearfix">
								<font>工程师编号</font>
								<div class="input-box">
									<input type="text" name='seid' data-rule="required;digits;remote[/member/userfarm/checkCounty]"  />
								</div>
							</div>
