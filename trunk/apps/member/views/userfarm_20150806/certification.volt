...
<div class="center-wrapper pb30">
	<div class="bread-crumbs w1185 mtauto">
		<a href="/">首页</a> > <a href="/member">个人中心</a> > 认证详细信息
	</div>
				...
				<div class="enterprise-company">
					...
					<div class="certificate">
						<div class="box">
							...
							<div class="message clearfix">
								<font>农场名：</font>
								<div class="msg-box">{{UserFarm['farm_name']}}</div>
							</div>
							<div class="message clearfix">
								<font>农场地址：</font>
								<div class="msg-box">{{ UserFarm['province_name'] }}{{ UserFarm['city_name'] }}{{ UserFarm['district_name']	 }}{{ UserFarm['town_name'] }}{{UserFarm['village_name']}}</div>
							</div>
							<div class="message clearfix">
								<font>土地来源：</font>
								<div class="msg-box">{{ UserFarm['source'] == 0 ? '自有' : '流转' }}</div>
							</div>
							<div class="message clearfix">
								<font>年限：</font>
								<div class="msg-box">{{ UserFarm['year']}}年{{UserFarm['month']}}月</div>
							</div>
							{% endif %}
					...
					<div class="certificate">
						<div class="box">
							...
							<div class="message clearfix">
								<font>公司地址：</font>
								<div class="msg-box">{{ info.province_name }}{{ info.city_name }}{{ info.district_name	 }}{{ info.town_name }}{{ info.address }}</div>
							</div>
							{% if info.credit_type == 8 %} 
							<div class="message clearfix">
								<font>农场名：</font>
							...
							{% if info.credit_type == 8 or info.credit_type == 16 %}
							<div class="message clearfix">
								<font>{{ info.credit_type == 16 ? '采购作物：' : '种植作物：'}}</font>
								<div class="msg-box">{{ frmaCrops}}</div>
							</div>
							{% else %}
								{% if UserArea%} 
