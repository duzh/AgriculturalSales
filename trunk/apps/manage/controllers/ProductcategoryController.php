...
class ProductCategoryController extends ControllerMember
{
    ...
    public function createAction()
    {
        ...
        if (!$articlecategory->save()) {
            parent::msg($message,'/manage/productcategory/new');
        ...
        parent::msg('文章分类添加成功','/manage/productcategory/index');
    ...
    public function saveAction()
    {
        ...
        $articlecategory = Category::findFirstByid($id);
        if (!$articlecategory) {
            parent::msg('文章分类未找到'. $id,'/manage/productcategory/index');
        ...
        if (!$articlecategory->save()) {
            parent::msg($message,"/manage/productcategory/edit/{$id}");
            // foreach ($articlecategory->getMessages() as $message) {
            //     $this->flash->error($message);
            // }
        ...
        parent::msg('文章分类修改成功','/manage/productcategory/index');
