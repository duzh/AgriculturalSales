...
class AdvisorycategoryController extends ControllerMember
{
    ...
    public function editAction($id)
    {
        ...
        if (!$this->request->isPost()) {
            ...
            if (!$articlecategory) {
                parent::msg('文章分类未找到','/manage/productcategory/index');
    ...
    {
        if (!$this->request->isPost()) {
            $this->response->redirect("advisorycategory/index")->sendHeaders();
        }
        ...
        if (!$articlecategory->save()) {
            parent::msg($message,'/manage/advisorycategory/index');
        ...
        Func::adminlog("添加文章分类：{$articlecategory->id}");
        parent::msg('文章分类添加成功','/manage/advisorycategory/index');
    ...
    public function saveAction()
    {
        ...
        $articlecategory = Category::findFirstByid($id);
        if (!$articlecategory) {
            parent::msg('文章分类未找到','/manage/advisorycategory/index');
    ...
    public function deleteAction($id)
    {
        $articlecategory = Category::findFirstByid($id);
        if (!$articlecategory) {
            parent::msg('文章分类不存在','/manage/productcategory/index');
        ...
        if (!$articlecategory->delete()) {
            parent::msg($message,'/manage/productcategory/index');
            // foreach ($articlecategory->getMessages() as $message) {
            //     $this->flash->error($message);
            // }
        ...
        Func::adminlog("删除文章分类：{$articlecategory->catname}");
        parent::msg('删除成功','/manage/productcategory/index');
