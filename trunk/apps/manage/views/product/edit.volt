...
{{ content() }}
{{ form("product/save", "method":"post",'id':'myarticle') }}
<script type="text/javascript" charset="utf-8" src="/ueditor/ueditor.config.js"></script>
<script type="text/javascript" charset="utf-8" src="/ueditor/ueditor.all.min.js"></script>
<script type="text/javascript" charset="utf-8" src="/ueditor/lang/zh-cn/zh-cn.js"></script>
<link rel="stylesheet" type="text/css" href="{{ constant('STATIC_URL') }}mdg/manage/css/style.css" />
<div class="main_right">
    <div class="bt2">编辑产品文章</div>
    <div class="tab2">
<ul id="test2_li_now_">
...
<div class="cx">
         <table width="100%" border="0" cellspacing="0" cellpadding="0" style=" border:none;">
                ...
                <tr>
                    ...
                    <td class="cx_content">{{ text_field("keywords", "size" : 30) }}</td>
                </tr>
                <tr>
                    <td class="cx_title">标签：</td>
                    <td class="cx_content">{{ text_field("tags", "size" : 30) }}</td>
                </tr>
                <tr>
...
<!--
    ...
    function setCheck() {
        $.getJSON('/manage/productcategory/ajax', {pid : {{ art.cid }}}, function(data) {
