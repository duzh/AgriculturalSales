        ...
        <div class="chaxun vip-list">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr height="40">
                    ...
                    <td width="35%"><input type="text" name="lwtt_phone" value="<?php echo isset($_GET['lwtt_phone'])&&$_GET['lwtt_phone']? $_GET['lwtt_phone']:'';?>"></td> 
                    <th width="15%">审核状态</th>
                    <td width="35%">
            ...
            <ul>
                <li>
                    ...
                    <div>
                        ...
                        <input name="reject" type="text"  value=''  data-rule="拒绝理由:required;length[~300];" data-target="#rejectinputID"   />
...
<script type="text/javascript">
    function setreject(){
        ...
        if($('#zjuser_id').val() && $('#zjcredit_id').val()){
            window.location='/manage/corporate/get/'+$('#zjuser_id').val()+'/8/if/'+$('#zjcredit_id').val()+'?reject='+$("input[name='reject']").val();
        }
        else{
            alert('参数错误');
        }
