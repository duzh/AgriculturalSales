    ...
    <div class="chaxun vip-list">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr height="30">
				...
				<th width="15%">服务工程师</th>
                <td width="35%"><input type="text" name="se_mobile" value="{% if userinfo %}{{userinfo.se_mobile ? userinfo.se_mobile : ''}}{% endif %}"></td>
                <th width="15%"></th>
                <td width="35%"></td>
            </tr>
...
$("#myarticle").validator({
     fields:  {
         userarea_district:"required;remote[/manage/corporate/checkUserFarmArea]",
     },
