    ...
    <div class="main_right">
        ...
        <div align="left" style="margin-top:20px;margin-left:20px">
          <ul class="zhibiaoTab">
            ...
            <li  class="active"><a href="/manage/crediblefarm/picturewall/{{user_id}}">图片墙</a></li>
...
<!-- 弹框 -->
  ...
  <div class="plant-add-box" style="width:472px; margin-left:-236px;">
    <form action="/manage/crediblefarm/picturewallsave" method="post" id="perfect"> 
    <a class="close-btn" href="javascript:;"></a>
    <div class="title">新增图片墙</div>
    ...
    <div class="message clearfix">
      ...
      <div class="area-box" id="textArea">
        <textarea name="contents" data-rule="内容:length[1~400]"></textarea>
...
<script>
    ...
    bankImg($('#ent_logo_pic'),39,$('#ent_show_logo_pic'),$('#ent_logo_pic_hide'));
    });
