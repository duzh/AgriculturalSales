    ...
    <div class="main_right">
        ...
        <div align="left" style="margin-top:20px;margin-left:20px">
          <ul class="zhibiaoTab">
            ...
            <li  class="active"><a href="/manage/crediblefarm/qualifications/{{user_id}}">资质认证</a></li>
...
<!-- 弹框 -->
  ...
  <div class="plant-add-box" style="width:472px; margin-left:-236px;">
    <form action="/manage/crediblefarm/qualificationssave" method="post" id="perfect"> 
    <a class="close-btn" href="javascript:;"></a>
    <div class="title">新增资质认证</div>
      ...
      <font>上传照片</font>
        <div class="loadImg-box" style="position:relative;">
          <div class="file-btn">
            ...
            <p style="margin-left:-270px">图片规格185 X 295</p>
