    ...
    <div class="main_right">
        ...
        <div align="left" style="margin-top:20px;margin-left:20px">
          <ul class="zhibiaoTab">
            ...
            <li  class="active"><a href="/manage/crediblefarm/footprint/{{user_id}}">发展足迹</a></li>
...
<!-- 弹框 -->
  ...
  <div class="plant-add-box" style="width:472px; margin-left:-236px;">
    <form action="/manage/crediblefarm/footprintsave" method="post" id="perfect"> 
