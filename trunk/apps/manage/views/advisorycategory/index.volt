...
<div class="main">
    <div class="main_right">
        <div class="bt2">资讯分类列表</div>
        {{ form("/advisorycategory/index", "method":"get", "autocomplete" : "off") }}
        <div class="chaxun">
    ...
    <div class="neirong" id="tb">
        ...
        {% for articlecategory in data.items %}
            <tr align="center">
                <td><?php echo $i++ ;?></td>
                <td><?php echo Mdg\Models\AdvisoryCategory::getcategory($articlecategory->pid)?> </td>
                ...
                <td>
                    {{ link_to("advisorycategory/edit/"~articlecategory.id, "修改") }}
...
{{ form("advisorycategory/index", "method":"get") }}
<div class="fenye">
    <div class="fenye1">
        <span>{{ pages }}</span>
...
$(function(){
 ...
 {  
    ...
    $.get('/manage/advisorycategory/checkarticle/', {id:id}, function(data) {
   
       if(data=="no"){
           alert("请先删除子分类");
       }else if(data=="yes"){
            if(confirm("您确定要删除吗?")){
                  location.href='/manage/advisorycategory/delete/'+id;
            }else{
