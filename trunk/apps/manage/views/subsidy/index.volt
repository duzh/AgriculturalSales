...
<div class="main">
  <div class="main_right">
    <div class="bt2">补贴管理</div>
    {{ form("subsidy/index", "method":"get", "autocomplete" : "off") }}
    <div class="chaxun">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td  width="15%" height="35" align="right">补贴类型</td>
          <td  width="35%" height="35" align="left">
  ...
  <div class="neirong" id="tb">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr align="center">
        ...
        <td>
          <?php echo isset($_subsidy_type[$item['subsidy_type']]) ?  $_subsidy_type[$item['subsidy_type']] : ''?></td>
        <td><a href="/manage/orders/info?order_sn={{ item['order_no'] }}">{{ item['order_no'] }}</a></td>
        ...
        <td>
          <?php echo isset($_status[$item['status']]) ?  $_status[$item['status']] : ''?>
          
        </td>
       <td>
         
           
           <a href="/manage/subsidy/info/{{ item['subsidy_id'] }}">查看</a>
