				...
				<?php if(!empty($cat['child'])) { ?>
					...
					<option value="<?php echo $child['id']; ?>" <?php if($id==$child['id']){ echo "selected";} ?> >&nbsp&nbsp&nbsp<?php echo $child['title']; ?></option>
		                <?php if(!empty($child['child'])) { ?>
							<?php foreach ($child['child'] as $childthree) { ?>
							<option value="<?php echo $child['id']; ?>" <?php if($id==$childthree['id']){ echo "selected";} ?> >&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<?php echo $childthree['title']; ?></option>
							<?php } ?>
						<?php } ?>
