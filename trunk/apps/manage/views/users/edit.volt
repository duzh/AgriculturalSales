...
<div class="main">
  {{ form("users/save", "method":"post","id":"usersform") }}  
    ...
    <div class="cx">
         <table width="100%" border="0" cellspacing="0" cellpadding="0" style=" border:none;">
                ...
                <tr>
                    ...
                    <td class="cx_content">
                        ...
                        <select name="sex">
                            ...
                            <option value="0" {% if sex==0 %} selected {% endif %}>男</option>
                ...
                <tr>
                    ...
                    <td class="cx_content">
                        <a onclick="javascript:newWindows('change', '个人信息-头像', '/manage/users/uploadfile/{{user.id}}');"  >
                                <?php if(isset($picture_path) && $picture_path!=' '){ $path=$picture_path;}else{$path='';} ?>
                    ...
                    <td > 
                       <div class="cx_content1"> 
                            ...
                            <select name="town" class="selectAreas" id="town">
                             ...
                             <select name="areas_name" class="selectAreas" id="cun">
                                <option value="">请选择</option>
                            </select>
                            <span class="msg-box" style="position:static;" for="areas_name"></span>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="cx_content">
                        <div class="msg-box">
                            ...
                            {{val['category_name']}}
                            {% endfor %}
                            <a href="javascript:;" onclick = "editForm(0)">修改</a>
                            {% else %}
                ...
                <tr>
                    ...
                    <td class="cx_content">
                        <div class="msg-box">
                            ...
                            {{val['category_name']}}
                            {% endfor %}
                            <a href="javascript:;" onclick = "editForm(1)">修改</a>
                            {% else %}
                ...
                <tr>
                 ...
                 <tr>
                    <td class="cx_title" valign="top" >新密码：</td>
                    <td class="cx_content">{{ password_field("password", "size" : 30) }}</td>
                </tr>
                 <tr>
                    <td class="cx_title" valign="top" >确认新密码：</td>
                    <td class="cx_content">{{ password_field("confirmpassword", "size" : 30) }}</td>
                </tr>
         </table>
  ...
  <!-- 采购修改 弹层 -->
    ...
    <div class="vip-box">
        ...
        <!-- <input class="btn" style="width:120px; height:32px; display:block; margin-top:10px; line-height:32px; margin:0 auto;" type="submit" value="确定" onclick="addpur()" />  -->
        ...
        <!-- <input class="btn" style="  width: 121px;cursor: pointer;height: 31px;line-height: 31px;border: none;background: url(../images/qd1.png) no-repeat;font-size: 14px;font-weight: bold;color: #8AAF29;font-family: '微软雅黑';text-align: center;" type="submit" value="确定" onclick="addpur()" />  -->
