            ...
            <ul>
                <li>
                    ...
                    <div>
                        ...
                        <input name="reject" type="text"  value=''   maxlength="300"/>
...
<div class="chaxun vip-list">
    ...
    <div class="chaxun vip-list">
        ...
        {% else %}
             <tr height="30">
                <th width="15%">推荐人</th>
                <td width="35%">{% if userinfo %}{{userinfo.se_mobile ? userinfo.se_mobile : (userinfo.se_id ? userinfo.se_id : '-')}}{% else %}-{% endif %}</td>
                <th width="15%"></th>
                <td width="35%"></td>
            </tr>
        {% endif %}
    ...
    <div class="chaxun vip-list">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr height="30">
                ...
                <td width="35%">{% if userfarm %}{{userfarm.start_year ? userfarm.start_year : '-'}}{% else %}0{% endif %}月{% if userfarm %}{{userfarm.start_month ? userfarm.start_month : '-'}}{% else %}0{% endif %}日&nbsp;&nbsp;——&nbsp;&nbsp;{% if userfarm %}{{userfarm.year ? userfarm.year : '-'}}{% else %}0{% endif %}月{% if userfarm %}{{userfarm.month ? userfarm.month : '-'}}{% else %}0{% endif %}日</td>
            </tr>
