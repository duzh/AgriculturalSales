...
<head>
  ...
  <title>修改</title>
    <script type="text/javascript" src="/mdg/js/user_farm.js?sid=<?php echo $getid;?>&id=<?php echo rand(1,99);?>"></script>
...
<!--                      <div class="btn" style="text-align:left; padding:0; margin:0 0 20px;">
            ...
            <tr>
                ...
                <td class="cx_content">
                  <div id="ent_show_tax_registration">
                    {% if userbank %}
                  <img src="http://yncmdg.b0.upaiyun.com/{{userbank.identity_picture_org ? userbank.identity_picture_org : '/upload/identitypicturelicPath/2015/06/14/828668888408.jpg'}}" alt="组织机构代码证" width="150px" height="100px">
                   {% else %}
                  <img src="http://yncmdg.b0.upaiyun.com//upload/identitypicturelicPath/2015/06/14/828668888408.jpg " alt="" width="150px" height="100px">
                    {% endif %} 
                  </div>
...
<!--                      <div class="btn" style="text-align:left; padding:0; margin:0 0 20px;">
               ...
               <tr>
                ...
                <td class="cx_content">
                  <div id="ent_show_tax_registration">
                    {% if userbank %}
                  <img src="http://yncmdg.b0.upaiyun.com/{{userbank.identity_picture_tax ? userbank.identity_picture_tax : '/upload/identitypicturelicPath/2015/06/14/828668888408.jpg'}}" alt="税务登记证" width="150px" height="100px">
                   {% else %}
                  <img src="http://yncmdg.b0.upaiyun.com//upload/identitypicturelicPath/2015/06/14/828668888408.jpg " alt="" width="150px" height="100px">
                    {% endif %} 
                  </div>
