        ...
        <div class="cx">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style=" border:none;">
                ...
                <tr>
                    ...
                    <td class="cx_content">
                        ...
                        <select name="goods_unit" id="goods_unit" style="width: 120px;">
                            ...
                            {% if key > 0 %}
                            <option value="{{ key }}" {% if key == purchase.goods_unit  %} selected='selected' {% endif %}>{{ val }}</option>
                            {% endif %}
                            {% endfor %}
                        </select>
                ...
                <tr>
                    ...
                    <td class="cx_content"><input type="text" name="endtime" value="{% if purchase.endtime %}{{ date('Y-m-d', purchase.endtime) }}{% endif %}" id="endtime" class="txt" /></td>
                </tr>
                <tr>
