...
<div class="main">
    <div class="main_right">
        <div class="bt2">产品分类列表</div>
        {{ form("/productcategory/index", "method":"get", "autocomplete" : "off") }}
        <div class="chaxun">
    ...
    <div class="neirong" id="tb">
        ...
        {% for articlecategory in data.items %}
            <tr align="center">
                ...
                <td>
                    {{ link_to("productcategory/edit/"~articlecategory.id, "修改") }}
...
{{ form("productcategory/index", "method":"get") }}
<div class="fenye">
    <div class="fenye1">
        <span>{{ pages }}</span>
...
$(function(){
 ...
 {  
    ...
    $.get('/manage/productcategory/checkarticle/', {id:id}, function(data) {
   
       if(data=="no"){
           alert("请先删除子分类");
       }else if(data=="yes"){
            if(confirm("您确定要删除吗?")){
                  location.href='/manage/productcategory/delete/'+id;
            }else{
...
<!--
    ...
    function setCheck() {
        $.getJSON('/manage/productcategory/ajax', function(data) {
