<?php
require_once (dirname(__FILE__).'/../ebusclient/PaymentRequest.php');
...
if(!empty($_POST["ProductName"])){
	foreach ($_POST["ProductName"] as $key => $value) {
		...
		$orderitem["ProductName"] = $value['goods_name']; //商品名称
		$orderitem["UnitPrice"] = $value['shop_price']; //商品总价
		...
		$tRequest->orderitems[$key] = $orderitem;
    }
}
...
// $orderitem["ProductID"] = "IP000001"; //商品代码，预留字段
// $orderitem["ProductName"] = $_POST['ProductName']; //商品名称
